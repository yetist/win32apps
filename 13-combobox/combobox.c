            ...
            case IDM_FONTSIZE:
              switch (HIWORD(wParam))
                ...
                case CBN_SELCHANGE:
                      ...
                      SendMessage (hWndComboBoxFontSize, CB_GETLBTEXT, (WPARAM) iSelect, (LPARAM) (LPCSTR) szFontSize);
                      LogFont.lfHeight = -MulDiv (atoi (szFontSize), LogPixelSy, 72);
                      }
                  break;
                  }
              break;
